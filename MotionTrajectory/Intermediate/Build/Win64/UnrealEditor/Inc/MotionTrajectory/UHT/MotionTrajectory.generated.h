...
// ********** Begin ScriptStruct FMotionTrajectorySettings *****************************************
#define FID_Engine_Plugins_Experimental_Animation_MotionTrajectory_Source_MotionTrajectory_Public_MotionTrajectory_h_27_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FMotionTrajectorySettings_Statics; \
	MOTIONTRAJECTORY_API static class UScriptStruct* StaticStruct();


struct FMotionTrajectorySettings;
// ********** End ScriptStruct FMotionTrajectorySettings *******************************************
